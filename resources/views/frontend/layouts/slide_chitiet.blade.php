<script src="{{asset('public/js/jssor.slider-22.0.6.min.js')}}" type="text/javascript"></script>
    ...
    <style>
        ...
        */
        .jssora22l, .jssora22r {
            ...
            height: 58px;
            cursor: pointer;
            background: url('../public/images/a22.png') center center no-repeat;
            overflow: hidden;
        }
    ...
    <div id="jssor_1" style="position: relative; margin:0 auto; top: 0px; left: 0px; width: 1300px; height: 500px; overflow: hidden; visibility: hidden;">
        ...
        @foreach($images as $image)
			<div data-p="225.00" style="display: none;">
                <img data-u="image" src="{!! asset($image->path) !!}" />
            </div>
		 @endforeach
        </div>
        <!-- Bullet Navigator -->
