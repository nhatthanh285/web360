...
<body>
  ...
  if (document.body.scrollTop > 500 || document.documentElement.scrollTop > 500) { document.getElementById("banner").className = "show";       
     ...
     <img id="backgr" src="{!! asset("public/images/bds.png") !!}">
    ...
    <div class="row circle">
       <a href="" title=""><img class="img1" src="{!! asset("public/image/circle1.gif") !!}"></a>
       <a href="" title=""><img class="img2" src="{!! asset("public/image/circle2.gif") !!}"></a>
    </div>
