  ...
  <h3 style="margin-top:80px ">Mua bán Bất động sản - Mua bán trên Toàn quốc</h3>
	...
	<div class="col-md-1">
		...
		<div class="col-md-3 drop">
	          <div class="dropdown">
                 <button id="diadiem" class=" btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">
                  Toàn Quốc
		...
		<div class="col-md-3" >
			  <div class="dropdown" >
                 <button id="type" class=" btn btn-default dropdown-toggle" type="button" data-toggle="dropdown">
                  Bất Động Sản - Mua bán
                 <span class="caret"></span></button>
                 <ul class="dropdown-menu">
                    <li><a href="#"> Bất Động Sản - Mua</a></li>
